...
Если в рассылке заполнить поле "дата прекращения рассылки", то в этот день будет отправлено последнее напоминание с текстом "текст последней рассылки" и задача будет деактивирована, иначе напоминания будут отсылаться до тех пор пока пользователь не закроет задачу.
