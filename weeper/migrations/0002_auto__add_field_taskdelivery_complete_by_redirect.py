...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskDelivery.complete_by_redirect'
        db.add_column(u'weeper_taskdelivery', 'complete_by_redirect',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskDelivery.complete_by_redirect'
        db.delete_column(u'weeper_taskdelivery', 'complete_by_redirect')
