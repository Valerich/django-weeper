...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.last_email_text'
        db.add_column(u'weeper_task', 'last_email_text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Task.send_last_email'
        db.add_column(u'weeper_task', 'send_last_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TaskDelivery.last_email_text'
        db.add_column(u'weeper_taskdelivery', 'last_email_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'TaskDelivery.task_url'
        db.alter_column(u'weeper_taskdelivery', 'task_url', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Task.last_email_text'
        db.delete_column(u'weeper_task', 'last_email_text')

        # Deleting field 'Task.send_last_email'
        db.delete_column(u'weeper_task', 'send_last_email')

        # Deleting field 'TaskDelivery.last_email_text'
        db.delete_column(u'weeper_taskdelivery', 'last_email_text')


        # Changing field 'TaskDelivery.task_url'
        db.alter_column(u'weeper_taskdelivery', 'task_url', self.gf('django.db.models.fields.URLField')(max_length=200))
