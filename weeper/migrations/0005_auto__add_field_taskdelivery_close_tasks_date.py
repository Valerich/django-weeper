...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskDelivery.close_tasks_date'
        db.add_column(u'weeper_taskdelivery', 'close_tasks_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskDelivery.close_tasks_date'
        db.delete_column(u'weeper_taskdelivery', 'close_tasks_date')
