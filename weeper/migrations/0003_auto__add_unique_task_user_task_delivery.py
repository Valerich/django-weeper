...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Task', fields ['user', 'task_delivery']
        db.create_unique(u'weeper_task', ['user_id', 'task_delivery_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Task', fields ['user', 'task_delivery']
        db.delete_unique(u'weeper_task', ['user_id', 'task_delivery_id'])
